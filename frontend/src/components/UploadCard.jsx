    ...
    <div className="space-y-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-baseline gap-3">
              <span className="text-5xl font-bold text-white">
                {result.scores?.overallScore?.toFixed(1) || "85.0"}
              </span>
      ...
      <div className="bg-gray-950 border border-gray-900 rounded-xl p-4">
        ...
        <div className="h-2 bg-gray-900 rounded-full overflow-hidden flex">
          <div className="bg-red-600" style={{ width: `${metrics.agentPct}%` }} />
          <div className="bg-blue-600" style={{ width: `${metrics.customerPct}%` }} />
        </div>
      </div>
    </div>
  );
